package br.com.danilopaixao.driver.test;
...
import br.com.danilopaixao.driver.DriverServiceApplication;
...
//    }
    ...
    public void shouldRegisterClientInEurekaServer() throws InterruptedException {
        ...
        //ResponseEntity<String> response = this.testRestTemplate.getForEntity("http://localhost:8761/service-instances/vehicle", String.class);
