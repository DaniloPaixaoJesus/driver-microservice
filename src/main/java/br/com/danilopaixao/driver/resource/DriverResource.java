...
public class DriverResource {
	...
	public Driver insertDriver(@RequestBody(required = true) final Driver driver) {
		return new Driver("93418DF0R09QSDF", "Kalles Grustransporter", "AB", "Cementvägen 8, 111 11 Södertälje");
	}
